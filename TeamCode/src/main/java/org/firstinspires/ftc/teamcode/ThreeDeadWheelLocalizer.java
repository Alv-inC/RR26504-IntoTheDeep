...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = -9908.623400430988; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = 11010.687194414835; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = -6401.043944368749; // x position of the perpendicular encoder (in tick units)
    }
